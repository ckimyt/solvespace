...
bool SolveSpaceUI::SaveToFile(const char *filename) {
    ...
    SMesh *m = &(SK.group.elem[SK.group.Size()-1].runningMesh);
    ...
    SShell *s = &(SK.group.elem[SK.group.Size()-1].runningShell);
